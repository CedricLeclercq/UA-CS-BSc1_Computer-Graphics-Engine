...
void img::EasyImage::draw2DLines (const Lines2D &lines, const int size) {
    ...
    for (auto line: lines) {
        ...
        //cout << "x: " << line.p1.x << endl;
        //cout << "y: " << line.p1.y << endl;
        //cout << "x: " << line.p2.x << endl;
        //cout << "y: " << line.p2.y << endl << endl;
        // First point
    ...
    for (auto line: lines) {
        ...
        this->draw_line(ceil(line.p1.x),ceil(line.p1.y),ceil(line.p2.x),ceil(line.p2.y),img::Color(line.color.red,line.color.green,line.color.blue));
    }
}
