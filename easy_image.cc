...
void img::EasyImage::draw_zbuf_triag(ZBuffer & zBuffer, Vector3D const * A, Vector3D const * B, Vector3D const * C, double d, double dx, double dy, const Color& color) {
    ...
    cout << "PAx: " << projectedA.x << endl;
    cout << "PAy: " << projectedA.y << endl;
    cout << "PBx: " << projectedB.x << endl;
    cout << "PBy: " << projectedB.y << endl;
    cout << "PCx: " << projectedC.x << endl;
    cout << "PCy: " << projectedC.y << endl << endl << endl;
